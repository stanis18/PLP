...
public class ExpGreaterThanEquals extends ExpBinaria{

	public ExpGreaterThanEquals(Expressao esq, Expressao dir) {
		super(esq, dir, ">=");
	}
	...
	public ExpBinaria clone() {
		return new ExpGreaterThanEquals(esq.clone(), dir.clone());
	}
